...
class PlacarVoleiTenisMesaEle extends StatefulWidget {
  @override
  _PlacarVoleiTenisMesaEleState createState() =>
      _PlacarVoleiTenisMesaEleState();
}

class _PlacarVoleiTenisMesaEleState extends State<PlacarVoleiTenisMesaEle> {
  int placarEquipeA = 0;
  int placarEquipeB = 0;
  ...
  void resetar() async {
    ...
    await _tempoPlacar.set(formatarTempo(segundos));
  }
  ...
  void iniciarTemporizador() {
    timer = Timer.periodic(Duration(seconds: 1), (Timer t) {
      setState(() {
        ...
        _tempoPlacar.set(formatarTempoBanco(segundos));
