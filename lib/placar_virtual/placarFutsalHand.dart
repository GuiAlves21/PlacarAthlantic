...
class PlacarFutsalHand extends StatefulWidget {
  @override
  _PlacarFutsalHandState createState() => _PlacarFutsalHandState();
}

class _PlacarFutsalHandState extends State<PlacarFutsalHand> {
  int placarEquipeA = 0;
  int placarEquipeB = 0;
